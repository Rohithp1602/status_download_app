...
import 'package:structureproject/ui/main/home_screen/home_screen_controller.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeScreenController>(initState: (initState) {
      homeScreenController.getGroupList();
    }, builder: (ctrl) {
      return Scaffold(
        key: scaffoldKey,
